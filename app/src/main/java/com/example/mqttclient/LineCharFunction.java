...
public class LineCharFunction {
    ...
    //一条曲线
    public LineCharFunction(LineChart mLineChart, String name, int color) {
    ...
    //多条曲线
    public LineCharFunction(LineChart mLineChart, List<String> names, List<Integer> colors) {
        this.lineChart = mLineChart;
        leftAxis = lineChart.getAxisLeft();
        rightAxis = lineChart.getAxisRight();
        xAxis = lineChart.getXAxis();
